-- ============================================================
--  MindSpark Game — MySQL Database Schema
--  Run this once on your MySQL server to set up all tables.
--
--  Usage (XAMPP):
--    1. Open phpMyAdmin → Import → choose this file
--    OR
--    mysql -u root -p < database/schema.sql
-- ============================================================

CREATE DATABASE IF NOT EXISTS mindsparkgame
...
-- â”€â”€ Classrooms â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
CREATE TABLE IF NOT EXISTS items (
  ...
  -- Stat bonuses (nullable = no bonus)
...
CREATE TABLE IF NOT EXISTS game_progress (
  ...
  quest_flags      TEXT         DEFAULT NULL  COMMENT 'JSON object',
  completed_levels TEXT         DEFAULT NULL  COMMENT 'JSON array of level IDs',
  level_stars      TEXT         DEFAULT NULL  COMMENT 'JSON {levelNumber: starRating}',
  ...
  PRIMARY KEY (id),
  -- One progress row per character (upsert target)
...
-- ── Parent Email Column (legacy — parent notifications removed in 2026-06) ─────
-- ALTER TABLE users ADD COLUMN parent_email VARCHAR(255) DEFAULT NULL AFTER avatar_url;
